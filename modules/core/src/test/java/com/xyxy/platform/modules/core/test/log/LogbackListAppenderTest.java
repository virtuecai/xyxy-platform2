 ...
 *******************************************************************************/
package com.xyxy.platform.modules.core.test.log;
...
public class LogbackListAppenderTest {
	...
	public void addAndRemoveAppender() {
		...
		// name
		appender.clearLogs();
		appender.addToLogger("com.xyxy.platform.modules.core.test.log");
		logger.warn(testString);
		assertThat(appender.getFirstLog()).isNotNull();

		appender.clearLogs();
		appender.removeFromLogger("com.xyxy.platform.modules.core.test.log");
		logger.warn(testString);
		assertThat(appender.getFirstLog()).isNull();
	}
}
